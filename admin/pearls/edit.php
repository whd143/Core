...
if (isset($_POST['submit'])) {
    ...
    $golden_word_id = isset($_POST['golden_word_id']) ? $_POST['golden_word_id'] : NULL;
    $query = <<<HDOC
                    UPDATE  `golden_word` 
                    SET 
                        ...
                        `quote_ur` =  '{$sql->real_escape_string($quote_ur)}',
                            ...
                            <form id="frm" name="frm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="publish_on">
                                            Publish Date : 
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="ayat_ur">
                                            Ayat (UR) : 
                                            <span class="mandatory"> * </span>
                                        </label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="hadith_ur">
                                            Hadith (UR) :                                            
                                            <span class="mandatory"> * </span>
                                        </label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="quote_ur">
                                            Quote (UR) : 
                                            <span class="mandatory"> * </span>
