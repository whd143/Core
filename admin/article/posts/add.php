                        ...
                        <form id="frm" name="frm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            <fieldset>
                                        ...
                                        <select id="category_id" name="category_id" >
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($category_record = $result->fetch_object()) {
                                                    echo ' <option value="' . $category_record->category_id . '">' . $category_record->title_en . ' | ' . $category_record->title_ur . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class = "control-group">
                                    ...
                                    <div class = "controls">
                                        <input type = "radio" id = "active" name = "is_home" value = "1" />&nbsp;
                                        Yes
                                        <br />
                                        <input type = "radio" id = "inactive" name = "is_home" value = "0" checked />&nbsp;
                                        No
                                    </div>
                                </div>
                                ...
                                <div class = "control-group">
                                    ...
                                    <div class = "controls">
                                        <input type = "radio" id = "active" name = "is_featured" value = "1" />&nbsp;
                                        Yes
                                        <br />
                                        <input type = "radio" id = "inactive" name = "is_featured" value = "0" checked />&nbsp;
                                        No
                                    </div>
                                </div>
