    ...
    <div class="container"> 
        <div class="row">
            <div class="span12">
                ...
                <div class="panel">
                    <div class="panel-header"><i class="icon-tasks"></i> Static Pages Management<a href="<?php echo $base_url; ?>/article/posts/add.php" class="float-right">+ Add New Record</a></div>
